...
class ConsultaComprasAntecipaceisTeste {
    ...
    public void testeListaComprasAntecipaceisSucesso(String idEstabelecimento, String page, String limit ) {
        ...
        given().
                ...
                body("content[0]", is(notNullValue()))
        ;
    }
